    ...
    fun takePersistablePermission(context: Context, uri: Uri): Boolean {
        return try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S &&
                ...
                Log.d(
                    TAG,
                    "检测到Android 12+ Photo Picker URI，无法获取持久权限，但可以临时访问: $uri"
                )
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                ...
                Log.d(
                    TAG,
                    "Android 12+: 请求持久权限 - URI类型: ${uri.scheme}, 路径: ${uri.path}, 授权: ${uri.authority}"
                )
                ...
                try {
                    ...
                    Log.e(
                        TAG,
                        "Android 12+: 无法获取持久权限，请考虑使用OpenDocument代替GetContent: ${e.message}"
                    )
                    false
                }
            } else {
